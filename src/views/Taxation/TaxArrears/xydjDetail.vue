  ...
  <div class="box">
    ...
    <div v-if="detail.length !== 0" class="box2">
      ...
      <el-row class="cont">
        ...
        <el-col :span="12"><div class="grid-content bg-purple" />
          <span>评级机构：</span><span>{{ detail[0].authority }}</span>
        </el-col>
      </el-row>
      ...
      <el-row class="cont">
        <el-col :span="12"><div class="grid-content bg-purple" />
          <span>等级：</span><span>{{ detail[0].eventResult }}</span>
        </el-col>
        <el-col :span="12"><div class="grid-content bg-purple" />
...
<script>
import { getSatpartyXinDetail } from '@/api/Taxation'
export default {
  data() {
    return {
      query: {
  ...
  created() {
    ...
    getSatpartyXinDetail(this.query).then(res => {
    //   console.log(res)
