<template>
  <div class="box">
    ...
    <div v-if="detail.length !== 0" class="box2">
      ...
      <el-row class="cont">
        <el-col :span="12"><div class="grid-content bg-purple" />
          <span>登记结果：</span><span>{{ detail[0].eventResult }}</span>
        </el-col>
        <el-col :span="12"><div class="grid-content bg-purple" />
      ...
      <el-row class="cont">
        <el-col :span="24"><div class="grid-content bg-purple" />
          <span>类别：</span><span>{{ detail[0].eventName }}</span>
        </el-col>
      <!-- <el-col :span="12"><div class="grid-content bg-purple" />
...
<script>
import { getSatpartyRegDetail } from '@/api/Taxation'
export default {
  data() {
    return {
      query: {
  ...
  created() {
    ...
    getSatpartyRegDetail(this.query).then(res => {
    //   console.log(res)
