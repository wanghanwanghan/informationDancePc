<template>
  <div
    style="width:100%;background-color: #162960;padding-top: 10px;min-height: 100%;background-size : cover; background-attachment: fixed;background-repeat:no-repeat;"
  >
    <div style="width: 1200px;margin: auto;height: 910px">
      ...
      <div style="height: 460px;width: 100%;margin: 30px 0px">
          ...
          >
            <div style="height: 50px">
              ...
              <div style="float: right;">
                <el-input v-model="entName" style="width: 250px" size="small">
                  <el-button
                    slot="append"
                    icon="el-icon-search"
            ...
            <div style="font-size: 12px">
              <div style="color: #405b84;height: 30px;width: 100%; cursor:pointer" @click="searchData=[]">清空历史记录<i
              ...
              <div style="color: #96c5e6">企业业务、团队稳定性、企业股东层稳定性、履约能力方面分析，抗风险能力<span style="font-weight: bold;" class="remark">{{ remark }}</span></div>
            </div>
          </div>
        </div>
        ...
        <div style="width: 24%;float: left">
          ...
          <div>
            ...
            <div>
              <div id="leftChart" ref="leftChart" style="width: 240px; height: 210px" />
            </div>
        ...
        <div style="float: right;width: 4%;color: #FFFFFF;margin-top: 170px;">
          <div style="height: 30px">
            <div style="float:left;width: 20px;height: 15px;background-color: #5cc73b" />
            <div style="float: right">优</div>
          </div>
          <div style="height: 30px">
            <div style="float:left;width: 20px;height: 15px;background-color: #f49f44" />
            <div style="float: right">中</div>
          </div>
          <div style="height: 30px">
            <div style="float:left;width: 20px;height: 15px;background-color: #d7485f" />
      ...
      <div style="height: 200px">
        ...
        <div id="rightChart1" ref="rightChart" style="width: 170px; height: 170px;float:left;" />
        <div id="rightChart2" ref="rightChart" style="width: 170px; height: 170px;float:left;" />
        <div id="rightChart3" ref="rightChart" style="width: 170px; height: 170px;float:left;" />
        <div id="rightChart4" ref="rightChart" style="width: 170px; height: 170px;float:left;" />
        <div id="rightChart5" ref="rightChart" style="width: 170px; height: 170px;float:left;" />
        <div id="rightChart6" ref="rightChart" style="width: 170px; height: 170px;float:left;" />
        <div id="rightChart7" ref="rightChart" style="width: 170px; height: 170px;float:left;" />
      </div>
    </div>
...
import { getFengXian } from '@/api/article'
      ...
      getFengXian(this.query).then(res => {
        ...
        if (res.data.code === 200) {
          ...
          if (this.zongFen < 31) {
            ...
            this.remark = '较强'
            this.$el.getElementsByClassName('remark').item(0).style.color = '#5cc73b'
            // this.$el.getElementBy
          } else if (this.zongFen > 30 && this.zongFen < 41) {
            this.$el.getElementsByClassName('zhongshang').item(0).style.display = ''
            this.$el.getElementsByClassName('remark').item(0).style.color = '#3ba2c7'
            this.remark = '较强'
          } else if (this.zongFen > 40 && this.zongFen < 60) {
            this.$el.getElementsByClassName('zhong').item(0).style.display = ''
            this.$el.getElementsByClassName('remark').item(0).style.color = '#f49f44'
            this.remark = '较强'
          } else if (this.zongFen > 60 && this.zongFen < 81) {
            this.$el.getElementsByClassName('zhongxia').item(0).style.display = ''
            this.$el.getElementsByClassName('remark').item(0).style.color = '#d444f4'
            if (this.zongFen > 60 && this.zongFen < 80) {
              this.remark = '一般'
            }
          } else if (this.zongFen > 80) {
            this.$el.getElementsByClassName('cha').item(0).style.display = ''
            this.$el.getElementsByClassName('remark').item(0).style.color = '#d7485f'
            this.remark = '较弱'
          }
