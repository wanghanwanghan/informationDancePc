            ...
            >
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  <el-button type="primary" size="mini" @click="sbHandleDetail(scope.row.Id)">查看详情</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
...
export default {
  ...
  methods: {
    ...
    sbHandleDetail(id) {
      this.sbQuery.entName = localStorage.getItem('entName')
      this.sbQuery.id = id
